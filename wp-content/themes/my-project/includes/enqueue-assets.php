...
function mkdo_theme_enqueue_assets() {
	...
	// Footer JS.
	$footer_js_url  = get_stylesheet_directory_uri() . '/assets/dist/scripts/footer.js';
	$footer_js_path = dirname( MKDO_THEME_ROOT ) . '/assets/dist/scripts/footer.js';
...
function mkdo_theme_enqueue_editor_assets() {
	...
	// Editor stylesheet.
	$editor_css_url = '/assets/dist/styles/editor.css';
...
function mkdo_theme_enqueue_customize_preview_js() {
	...
	// Customizer JS.
	$live_preview_js_url  = get_stylesheet_directory_uri() . '/assets/dist/scripts/customizer.js';
	$live_preview_js_path = dirname( MKDO_THEME_ROOT ) . '/assets/dist/scripts/customizer.js';
