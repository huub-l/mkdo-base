...
<div class="static-main">
	...
	// 1. Scans MKDO_THEME_PARTS_DIR for folders.
	...
	foreach ( glob( MKDO_THEME_PARTS_DIR . '*', GLOB_ONLYDIR ) as $mkdo_theme_dir ) {
	...
	// Loop folders.
	foreach ( $mkdo_theme_folders as $mkdo_theme_folder ) {
		$mkdo_theme_glob = glob( MKDO_THEME_PARTS_DIR . $mkdo_theme_folder . '/*.php' );
		?>
