...
class IFrames {
	...
	public function run() {
		...
		// Settings check.
		$do_run = apply_filters( MKDO_CORE_PREFIX . '_iframe_wcag_wrapper', true );
		if ( ! $do_run ) {
			return;
		}

		add_filter( 'the_content', array( $this, 'mkdo_core_iframe_wcag_compliance' ), 20 );
	}
	 ...
	 * @return string
	 */
	public function mkdo_core_iframe_wcag_compliance( $content ) {
