...
class Site_Map_Links {
	 ...
	 */
	public function run() {
		add_filter( 'wpseo_sitemap_entry', array( $this, 'mkdo_core_yoast_wpml_alternate_links_to_site_map_setup' ), 100, 3 );
		add_filter( 'wpseo_sitemap_url', array( $this, 'mkdo_core_yoast_wpml_alternate_links_to_site_map' ), 100, 2 );
	}
	 ...
	 */
	public function mkdo_core_yoast_wpml_alternate_links_to_site_map_setup( $url, $type, $post ) {
	 ...
	 */
	public function mkdo_core_yoast_wpml_alternate_links_to_site_map( $output, $url ) {
